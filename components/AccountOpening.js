...
function AccountOpening() {
  ...
  function AccountOpenFunction(event) {
    ...
    Axios.post(`${API_BASE_URL}/account`, {
      varFirstName: firstName,
      varSecondName: lastName,
      varAddressProof: addressProof,
      varStreet: street,
      varCity: city,
      varAccounttype: accountType
    })
      .then(response => {
        setFirstName("")
        setLastName("")
      ...
      <div className="container background-color-body margin_10px">
        <form onSubmit={AccountOpenFunction}>
          ...
          <div className="row">
            ...
            <div className="col-75">
              <input type="file" id="addressproofimage" name="addressproofimage" placeholder="Address Proof Image.." />
              <br />
              <br />
            </div>
          </div>
